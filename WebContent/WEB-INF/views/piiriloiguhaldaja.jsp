...
<pr:main>
			<form:form method="POST">
				...
				<label>Alates</label>			
				<input type="text" id="datepicker1" name="alates" value="${plhaldaja.alates}"/><br/>
				<label>Kuni</label>
				<input type="text" id="datepicker2" name="alates" value="${plhaldaja.kuni}"/><br/>
			  ...
			  <tr>
				...
				<tr>
					<td><input type="text" id="datepicker1" name="alates" value="${plhaldaja.alates}"/></td>
					<td><input type="text" id="datepicker2" name="alates" value="${plhaldaja.kuni}"/><br/></td>
				</tr>
